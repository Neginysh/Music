...
public interface LastfmApi {
    ...
    LiveData<ApiResponse<ArtistSearch>> getArtists(@Query("artist") String artistName,
    ...
    LiveData<ApiResponse<AlbumInfos>> getAlbumInfo(@Query("api_key") String apiKey,
    ...
    LiveData<ApiResponse<ArtistsTopAlbums>> getTopAlbums(@Query("artist") String artistName,
                                        @Query("api_key") String apiKey);
