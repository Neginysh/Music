...
public abstract class NetworkBoundResource<CacheObject, RequestObject> {
    ...
    private MediatorLiveData<Resource<CacheObject>> results = new MediatorLiveData<>(); //the data that is observed in the UI
                ...
                if(requestObjectApiResponse instanceof ApiResponse.ApiSuccessResponse){
                    ...
                    appExecutors.diskIO().execute(new Runnable() {
                        ...
                        public void run() {
                            ...
                            appExecutors.mainThread().execute(new Runnable() {  // mainThread bcs we wanna use setValue not postValue
                                @Override
                                public void run() {
    ...
    public final LiveData<Resource<CacheObject>> getAsLiveData(){
        return results;  //the single source of truth
    };
}
